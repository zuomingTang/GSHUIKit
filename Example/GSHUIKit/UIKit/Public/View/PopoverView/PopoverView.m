...
- (void)showToView:(UIView *)pointView isLeftPic:(BOOL)isLeftPic withActions:(NSArray<PopoverAction *> *)actions hideBlock:(void(^)(void))hideBlock
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.style = _style;
    [cell setAction:_actions[indexPath.row] isLeftPic:_isLeftPic];
